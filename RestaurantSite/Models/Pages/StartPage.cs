...
using RestaurantSite.Models.Blocks;
...
namespace RestaurantSite.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(RestaurantPage), typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder) }, // Pages we can create under the start page...
        ExcludeOn = new[] { typeof(RestaurantPage), typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage) })] // ...and underneath those we can't create additional start pages
